...
Adicione o behavior 'CakePtbr.AjusteHora' no seu model através da variável actsAs, porém neste behavior tem uma diferença em relação aos demais.
...
class Noticia extends AppModel {
	var $name = 'Noticia';
	var $actsAs = array('CakePtbr.AjusteHora'); // Primeiro caso
	var $actsAs = array('CakePtbr.AjusteHora' => 'campo_data'); // Segundo caso
	var $actsAs = array('CakePtbr.AjusteHora' => array('publicado', 'informado')); // Terceiro caso
}
</pre>
